...
def do_quiz_attempt_once(self, row, attempt_index, total_attempts):
    ...
    # Start attempt nếu Moodle hiện confirm page
    try:
    ...
    # Nếu đang ở trang câu hỏi, bấm Next page để tới Summary
    try:
    ...
    # Nếu vẫn có link Finish attempt ..., click nó để tới Summary
    try:
